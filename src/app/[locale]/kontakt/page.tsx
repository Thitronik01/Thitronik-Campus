...
export default function KontaktPage() {
    const content = legalContent.contact;
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4 sm:px-6 animate-fade-in pb-20">
            <div className="mb-8 border-b pb-6">
                ...
                <p className="text-muted-foreground mt-4 text-lg">{content.intro}</p>
            ...
            <div className="mt-12 pt-8 border-t border-border">
                <p className="text-sm mb-4 text-muted-foreground">{content.footerNotice}</p>
